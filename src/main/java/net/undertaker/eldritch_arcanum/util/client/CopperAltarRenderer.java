...
public class CopperAltarRenderer implements BlockEntityRenderer<CopperAltarEntity> {
    public CopperAltarRenderer(BlockEntityRendererProvider.Context context){
    }

    @Override
    public void render(
            CopperAltarEntity blockEntity,
            float partialTicks,
