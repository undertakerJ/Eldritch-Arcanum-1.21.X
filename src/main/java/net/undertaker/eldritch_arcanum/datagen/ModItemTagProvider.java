...
public class ModItemTagProvider extends ItemTagsProvider {
  ...
  protected void addTags(HolderLookup.Provider provider) {
    tag(ItemTags.SWORDS).add(ModItems.CEBBITE_SWORD.get()).add(ModItems.ADAMANTITE_SWORD.get());
    tag(ItemTags.SHOVELS).add(ModItems.CEBBITE_SHOVEL.get()).add(ModItems.ADAMANTITE_SHOVEL.get());
    tag(ItemTags.PICKAXES)
        .add(ModItems.CEBBITE_PICKAXE.get())
        .add(ModItems.ADAMANTITE_PICKAXE.get());
    tag(ItemTags.AXES).add(ModItems.CEBBITE_AXE.get()).add(ModItems.CEBBITE_AXE.get());
    tag(ItemTags.HOES).add(ModItems.CEBBITE_HOE.get()).add(ModItems.ADAMANTITE_HOE.get());
